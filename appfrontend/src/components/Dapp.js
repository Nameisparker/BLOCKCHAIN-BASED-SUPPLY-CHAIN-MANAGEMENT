...
export class Dapp extends React.Component {
  ...
  componentDidMount(){
    ...
    if (logoutParam) {
      ...
      // Clear any cached MetaMask data
      if (window.ethereum) {
        try {
          ...
          console.log('Error clearing cached accounts:', error);
        }
      }
      ...
      // Don't connect wallet immediately after logout
      // Let the user manually connect again
      return;
    }
